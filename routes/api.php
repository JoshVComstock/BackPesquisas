...
//inforamtiva 
use App\Http\Controllers\CentrosinfoController;
...
Route::get('/centrosinfo', [CentrosinfoController::class, 'index']);
Route::post('/centrosinfo', [CentrosinfoController::class, 'store']);
Route::delete('/centros/{id}', [CentrosinfoController::class, 'destroy']);
Route::put('centros/{id}', [CentrosinfoController::class, 'update']);
